      ...
      <div className="max-w-5xl mx-auto bg-white p-6">
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-base mb-6">am 26. September 2021</p>
                    ...
                    >
                      ...
                      <div className="flex-grow flex justify-between items-start">
                        ...
                        <div className="text-right">
                          <div
                              className="font-bold">{candidate.partyKurzbezeichnung?.startsWith("EB") ? "" : candidate.partyKurzbezeichnung}</div>
          ...
          <div className="mt-8 flex justify-center">
            <button
                type="submit"
                disabled={erststimme === -1 || zweitstimme === -1}
