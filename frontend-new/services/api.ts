...
export const electionApi = {
  ...
  getCurrentElection: async () => {
    try {
      const response = await api.get<Election>("ergebnisse/election/status");
  ...
  updateElectionStatus: async (id: number, isActive: boolean) => {
    try {
      const response = await api.patch<Election>(`/elections/${id}`, {
        isActive,
      });
      return response.data;
    } catch (error) {
  ...
  getSeatDistribution: async (year: number): Promise<Sitzverteilung[]> => {
    try {
      const response = await api.get<Sitzverteilung[]>(
        `/ergebnisse/sitzverteilung/${year}`
      );
      return response.data;
    } catch (error) {
  ...
  getParliamentMembers: async (
    year: number,
    bundesland_id: number
  ): Promise<Mandat[]> => {
    try {
      const response = await api.get<Mandat[]>(
        `/ergebnisse/bundestagsmitglieder/${year}/${bundesland_id}`
      );
      return response.data;
    } catch (error) {
  ...
  getConstituencyOverview: async (
    year: number,
    wahlkreis_id: number,
    useAggregation: boolean
  ): Promise<WahlkreisUebersicht> => {
    try {
      const response = await api.get<WahlkreisUebersicht>(
        `/ergebnisse/wahlkreis/uebersicht/${year}/${wahlkreis_id}/${useAggregation}`
      );
      return response.data;
    } catch (error) {
  ...
  getConstituencyWinners: async (year: number): Promise<WahlkreisSieger[]> => {
    try {
      const response = await api.get<WahlkreisSieger[]>(
        `/ergebnisse/wahlkreisSieger/${year}`
      );
      return response.data;
    } catch (error) {
  ...
  getOverhangSeats: async (
    year: number,
    grouping: string
  ): Promise<UberhangMandate[]> => {
    try {
      const response = await api.get<UberhangMandate[]>(
        `/ergebnisse/ueberhangmandate/${year}/${grouping}`
      );
      return response.data;
    } catch (error) {
  ...
  getClosestResults: async (year: number): Promise<KnappsteSieger[]> => {
    try {
      const response = await api.get<KnappsteSieger[]>(
        `/ergebnisse/knappsteSieger/${year}`
      );
      return response.data;
    } catch (error) {
  ...
  getConstituencyDetails: async (year: number, constituencyId: string) => {
    try {
      const response = await api.get<ConstituencyResult>(
        `/analysis/details/${year}/${constituencyId}`
      );
      return response.data;
    } catch (error) {
  ...
  getLiveResults: async () => {
    try {
      const response = await api.get<{
        ...
        totalVotes: number;
        voterTurnout: number;
      }>("/ergebnisse/analysis/live");

      return {
        firstVotes: response.data.firstVotes,
        secondVotes: response.data.secondVotes,
        totalVotes: response.data.totalVotes,
        voterTurnout: response.data.voterTurnout,
      };
    } catch (error) {
  ...
  getSocioCulturalStats: async (
    year: number,
    type: string
  ): Promise<SocioCulturalStats[]> => {
    try {
      const response = await api.get<SocioCulturalStats[]>(
        `/ergebnisse/socioCulturalStats/${year}/${type}`
      );
      return response.data;
    } catch (error) {
  ...
  getElectionStatus: async (): Promise<Election> => {
    try {
      const response = await api.get<Election>(`/ergebnisse/election/status`);
      return response.data;
    } catch (error) {
