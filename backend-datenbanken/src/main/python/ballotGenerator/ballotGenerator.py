...
INPUT_FILE = "zweitstimmeAggr.csv"  # Replace with the path to your input CSV file
OUTPUT_DIRECTORY = "zweiteStimmeExpanded"  # Directory to store the expanded files
...
def write_to_csv(rows, output_directory, file_count):
    output_file = os.path.join(output_directory, f"zweitestimme_{file_count}.csv")
