...
public class V50__init_vote_codes extends BaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        String createElection = "INSERT INTO elections (id, start_time, year, status, total_votes) VALUES (1, '2022-09-26 08:00:00', 2022, 'ACTIVE', 300);";
        executeSQL(connection, createElection);

        String insertSQL = "INSERT INTO vote_code (code, wahlkreis_id, election_id) VALUES (?, ?, (select id from elections where id = 1));";
