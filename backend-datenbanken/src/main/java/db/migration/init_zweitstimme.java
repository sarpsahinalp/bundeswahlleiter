...
public class init_zweitstimme extends BaseJavaMigration {

    private static final String EXPANDED_FILES_DIRECTORY = "src/main/resources/electionData/targetCSV/zweiteStimmeExpanded"; // Path to expanded files
